...
public class RedisClient {
	...
	private void initialPool() {
		...
		jedisPool = new JedisPool(config, RedisConstant.REDIS_SERVER,
	...
	private void initialShardedPool() {
		...
		shards.add(new JedisShardInfo(RedisConstant.REDIS_SERVER,
				RedisConstant.REDIS_PORT, RedisConstant.REDIS_MASTER));
