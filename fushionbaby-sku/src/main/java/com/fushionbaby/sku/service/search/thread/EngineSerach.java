		...
		try {
			...
			if(queryCondition !=null ){
				...
				if(StringUtils.isNotBlank(searchKey)){
					strQuery.append(searchKey +"OR skuName:"+searchKey);
				}
				...
				if(StringUtils.isNotBlank(queryCondition.getLabelCode())){
					if(StringUtils.isNotBlank(strQuery.toString())){
						strQuery.append(" AND ");
					}
					strQuery.append("skuLabel:*"+queryCondition.getLabelCode()+"*");
				}
				...
				if(StringUtils.equals(SortTypeConstant.PRICE, queryCondition.getSortParam())){
					if(StringUtils.equals(SortTypeConstant.desc, queryCondition.getSortType())){
						query.addSort("skuPrice",ORDER.desc);
					}else{
						query.addSort("skuPrice",ORDER.asc);
					}
				}
				if(StringUtils.equals(SortTypeConstant.SALES_VOLUME,queryCondition.getSortParam() )){
