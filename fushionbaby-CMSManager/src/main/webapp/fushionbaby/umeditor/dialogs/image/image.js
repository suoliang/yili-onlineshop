...
//                }
        ...
        callback: function (editor, $w, url, state) {
            ...
            if (state == "SUCCESS") {
                //显示图片计数+1
                Upload.showCount++;
                //"<img src='" + editor.options.imagePath + url + "' class='edui-image-pic' />"
                var $img = $("<img src='" + UMEDITOR_CONFIG._CONTEXTPATH + url + "' _src = '"+UMEDITOR_CONFIG._CONTEXTPATH + url+"' class='edui-image-pic' />"),
