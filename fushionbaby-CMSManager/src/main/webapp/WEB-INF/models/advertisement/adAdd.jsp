                ...
                <div class="col-md-12 content">
                    <div class="panel panel-info">
                        <div class="panel-heading">
                            <h3 class="panel-title"><i class="fa fa-cog"></i> 新增广告</h3>
                        </div>
                        <div class="panel-body">
                            <form class="form-horizontal" id="addRoleForm" action="${contextPath }/ad/addAd" method="post" enctype="multipart/form-data">
                                        ...
                                        <select name="sourceCode" class="form-control lg-select">
											<c:forEach items="${sysSourceList}" var="sourceList">
												<option value="${sourceList.code}"
													${sourceCode==sourceList.code?'selected':'' }>${sourceList.name}</option>
											</c:forEach>
										</select> 
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-5">
                                    <input name="picturePath" id="picturePath" type="hidden">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">展示顺序：</label>
                                     <div class="col-sm-5">
                                      <input name="showOrder"  type="number" class="form-control" min=1>
                                     </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="col-sm-offset-2 col-sm-10">
                                        <button type="submit" class="btn btn-info">确认新建广告</button>
