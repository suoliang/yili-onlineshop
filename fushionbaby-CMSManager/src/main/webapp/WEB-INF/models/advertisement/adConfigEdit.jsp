                ...
                <div class="col-md-12 content">
                    <div class="panel panel-info">
                        <div class="panel-heading">
                            <h3 class="panel-title"><i class="fa fa-cog"></i> 广告配置修改</h3>
                        </div>
                        <div class="panel-body">
                            <form class="form-horizontal" id="addRoleForm" action="${contextPath }/adConfig/updateAdConfig" method="post" enctype="multipart/form-data">
                                
                                <input name="id" type="hidden" value="${adConfig.id }">
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">广告名称：</label>
                                    <div class="col-sm-5">
                                    
                                       <input name="adName" type="text" class="form-control" value="${adConfig.adName }">
                                    	<%-- <select name="adCode">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-5">
                                        <input name="adCode" type="text" class="form-control" value="${adConfig.adCode }">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-5">
                                      <select name="sourceCode" class="form-control lg-select">
										<c:forEach items="${sysSourceList}" var="sourceList">
										  <option value="${sourceList.code}"	${adConfig.sourceCode==sourceList.code?'selected':'' }>${sourceList.name}</option>
										</c:forEach>
									  </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-5">
                                       <select  class="form-control lg-select" name="isUse">
											<option value="y" ${adConfig.isUse=='y'?'selected':'' }>开启</option>
											<option value="n" ${adConfig.isUse=='n'?'selected':'' }>不开启</option>
									  </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">说明：</label>
                                     <div class="col-sm-5">
                                      <textarea name="remark"   class="form-control">${adConfig.remark}</textarea>
                                     </div>
                                </div>
