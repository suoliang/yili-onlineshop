                ...
                <div class="col-md-12 content">
                    <div class="panel panel-info">
                        <div class="panel-heading">
                            <h3 class="panel-title"><i class="fa fa-cog"></i> 新增实体卡配置</h3>
                        </div>
                        <div class="panel-body">
                            <form class="form-horizontal" id="addRoleForm" action="${contextPath}/actEntityCardConfig/actEntityCardConfigAdd" method="post">
                                    ...
                                    <div class="col-sm-5">
                                        ...
                                        <input class="form-control form_datetime "  name="beginTime" type="text" />
                                    ...
                                    <div class="col-sm-5">
                                     <div class="input-group">
                                        <input class="form-control form_datetime "  name="expiration" type="text" />
									        <div class="input-group-addon form_datetime_addon"><i class="fa fa-times"></i></div>
								        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-sm-5">
                                        <input name="sellMoney" type="text" class="form-control">
                                    </div>
                                </div>
                                	<div class="form-group">
                                    <label class="col-sm-2 control-label">面值：</label>
                                    <div class="col-sm-5">
                                        <input name="faceMoney" type="text" class="form-control">
                                    </div>
                                </div>
