...
<head>
	<title>申请结算列表</title>
  	...
  	<script type="text/javascript">
  		function applyDetails(id){
  			window.location.href = "${contextPath }/storeSettleApply/applyDetails/"+ id + "/"+ new Date().getTime();
  		}
  		
  		
  		function exportExcel(){
  			$("#findForm").attr("action","${contextPath }/storeSettleApply/export_apply_settlement");
  			$("#findForm").submit();
  			$("#findForm").attr("action","${contextPath }/storeSettleApply/storeApplyList");
		}
  	</script>
</head>
<body>
			  ...
			  <div class="col-md-12 content">
				<div class="panel panel-info">
                   <div class="panel-heading">
                      <h3 class="panel-title"><i class="fa fa-cog"></i> 申请结算列表</h3>
                   </div>
                   <div class="panel-body">
				     <form class="form-inline page" id="findForm" method="post" action="${contextPath }/storeSettleApply/storeApplyList" >
		              ...
		              <div class="form-group col-md-4 mB15">
                       ...
                       <div class="form-group col-md-4 mB15">
                            <button type="submit" class="btn btn-success speBtn">查 询</button>
                       		<button type="button" onclick="exportExcel()"  class="btn btn-success speBtn">导出申请结算表</button>
                       </div>
                        ...
                        <table class="table table-bordered table-hover" id="roleTable">
                           <thead>
                            ...
                            <tbody>
                            	<c:forEach items="${list}" var="list" varStatus="status">
									<tr>
									   ...
									   <td> <a class="btn btn-warning btn-xs edit-role" href="javascript:void(0)"  
										 	 onclick="applyDetails('${list.id}')">详情</a>
										 	 </td>	
									  </tr>
								  </c:forEach>
                                </tbody>
                               ...
                               <!-- 分页 -->
	                            <tags:page formId="findForm" url="${contextPath }/storeSettleApply/storeApplyList"></tags:page>
	                            <!-- 分页 end -->
                           </div>
