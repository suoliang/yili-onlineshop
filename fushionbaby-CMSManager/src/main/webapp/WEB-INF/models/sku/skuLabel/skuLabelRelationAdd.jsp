                        ...
                        <div class="panel-body">
                            <form class="form-inline page" id="findForm" method="post">
                                ...
                                <div class="form-group col-md-3 mB15">
                                 ...
                                 <div class="form-group col-md-3 mB15">
                                    <label for="e">是否会员商品：</label>
                                    <select name="isMemberSku" class="form-control lg-select">
                                        <option value="">所有</option>
                                        <option value="y" <c:if test="${SkuDto.isMemberSku == 'y'}">selected="selected"</c:if> >是</option>
                                        <option value="n" <c:if test="${SkuDto.isMemberSku == 'n'}">selected="selected"</c:if> >否</option>
                                    </select>
                                </div>
                                    	...
                                    	<c:forEach items="${page.result}" var="sku" varStatus="status">
                                    		 <tr>
	                                            ...
	                                            <td>
	                                            	...
	                                            	<input type="hidden" name="labelCode" id="labelCode" value="${CURRENT_LABELD_CODE}">
	                                            </td>
                                        	</tr>
                                    	</c:forEach>
                                   </tbody>
