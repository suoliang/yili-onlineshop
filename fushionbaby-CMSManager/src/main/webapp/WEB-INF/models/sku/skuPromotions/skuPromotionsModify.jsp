	...
	$(document).ready(function() {
	    ...
	    var validator = $('#handleForm').validate({
	        ...
	        submitHandler: function(form) {
	            ...
	            $.post("${contextPath }/skuPromotions/updateSkuPromotions",{jsonStr:jsonStr },function(result){
	                if(result == "SUCCESS"){
		...
		<div class="pT30 mB0">
              <form class="form-horizontal" method="post"  id="handleForm">
				<div class="form-group mL0 mR0">
					...
					<div class="col-sm-4">
						<input name="promotionsName" id="promotionsName" type="text" class="form-control" value="${editPromotionsInfo.promotionsName}"/>
					</div>
				...
				<div class="form-group mL0 mR0">
					...
					<div class="col-sm-4">
						<input name="promotionsCode" id="promotionsCode" type="text" class="form-control" value="${editPromotionsInfo.promotionsCode}" readonly/>
					</div>
				</div>
					...
					<div class="col-sm-4">
						<div class="input-group">
							<input class="form-control form_datetime"  readonly name="startDate" 
										 type="text" value="<fmt:formatDate value="${editPromotionsInfo.startDate}" pattern="yyyy-MM-dd"/>">
					...
					<div class="col-sm-4">
						<div class="input-group">
							<input class="form-control form_datetime"  readonly name="endDate" 
										 type="text" value="<fmt:formatDate value="${editPromotionsInfo.endDate}" pattern="yyyy-MM-dd"/>">
							<div class="input-group-addon form_datetime_addon"><i class="fa fa-times"></i></div>
						</div>
					</div>
					<div class="error col-sm-4  textL">必填项</div>
				...
				<div class="form-group mL0 mR0">
					...
					<div class="col-sm-4">
						<input name="timeRange" id="timeRange" type="text" class="form-control" value="${editPromotionsInfo.timeRange}"/>
					</div>
					<div class="error col-sm-4  textL">必填项</div>
				...
				<div class="form-group mL0 mR0">
					...
					<div class="col-sm-4">
						...
						data-placeholder="Choose a Category" tabindex="1">
							<option value="y" ${editPromotionsInfo.isRepeatBuy=='y'?'selected':'' }>是</option>
							<option value="n" ${editPromotionsInfo.isRepeatBuy=='n'?'selected':'' }>否</option>
						</select>
					</div>
				</div>
				<div class="form-group mL0 mR0">
					...
					<div class="col-sm-4">
						<input name="salesPrice" id="salesPrice" type="text" class="form-control" value="${editPromotionsInfo.salesPrice}"/>
					</div>
					<div class="error col-sm-4  textL">必填项</div>
				</div>
