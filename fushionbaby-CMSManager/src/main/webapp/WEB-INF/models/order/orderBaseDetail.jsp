...
<html lang="zh-CN">
    ...
    <body id="orderDetail">
                                ...
                                <div class="col-md-6">
                                    <ul class="list-group">
                                        ...
                                        <li class="list-group-item">
                                            ...
                                            <span>${orderBase.auditFailReason}</span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
       ...
       <!-- 物流信息 -->
                    <div class="panel panel-info">
                        <div class="panel-heading">
                            <h3 class="panel-title"><i class="fa fa-shopping-cart"></i>订单物流信息</h3>
                        </div>
                        <div class="panel-body">
                            <!-- table -->
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover" id="">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                            ${orderTrans.transName}
                                            <c:if test="${orderBase.isPickUp=='y'}">自提</c:if>
                                            </td>
                                            <td>${orderTrans.transCode}</td>
                                            <td>
                                                 <c:choose>
                                            		<c:when test="${orderBase.transStatus =='y'}">已发货</c:when> 
												  	<c:otherwise>未发货</c:otherwise> 
                                             	</c:choose>
                                             </td>
                                            <td>${orderTrans.sendDate}</td>
                                            <td><fmt:formatDate value="${orderBase.lastReceiveTime}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
