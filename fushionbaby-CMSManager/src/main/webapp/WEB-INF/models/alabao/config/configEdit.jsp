                ...
                <div class="col-md-12 content">
                    <div class="panel panel-info">
                        <div class="panel-heading">
                            <h3 class="panel-title"><i class="fa fa-cog"></i> 修改如意宝配置</h3>
                        </div>
                        <div class="panel-body">
                            <form class="form-horizontal" id="addRoleForm" action="${contextPath }/alabaoConfig/configEdit" method="post">
                               <input name="id" type="hidden" value="${alabaoConfig.id }" >
                               <div class="form-group">
                                    <label class="col-sm-2 control-label">日利率：</label>
                                    <div class="col-sm-5">
                                        <input name="rate" type="text" value="${alabaoConfig.rate }" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-5">
                                     <div class="input-group">
                                        <input class="form-control form_datetime "  name="rebateTime" value="<fmt:formatDate value="${alabaoConfig.rebateTime }" pattern="yyyy-MM-dd"/>" type="text" />
