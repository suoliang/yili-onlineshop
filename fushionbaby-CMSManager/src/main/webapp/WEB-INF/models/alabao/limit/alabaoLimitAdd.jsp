...
<html lang="zh-CN">
    ...
    <body id="" class="Cog">
                ...
                <div class="col-md-12 content">
                    <div class="panel panel-info">
                        <div class="panel-heading">
                            <h3 class="panel-title"><i class="fa fa-cog"></i> 新增如意宝转出限制</h3>
                        </div>
                        <div class="panel-body">
                            <form class="form-horizontal" id="addRoleForm" action="${contextPath}/alabaoLimit/addAlabaoLimit" method="post">
                                
                                	<div class="form-group">
                                    <label class="col-sm-2 control-label">阿拉宝账户：</label>
                                    <div class="col-sm-5">
                                        <input name="account" id="account" type="text" class="form-control" placeholder="阿拉宝账户">
                                    </div>
                                </div>
                                	<div class="form-group">
                                    <label class="col-sm-2 control-label">转出限额：</label>
                                    <div class="col-sm-5">
                                        <input name="moneyLimit" type="text" class="form-control" placeholder="转出限额">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">次数限制：</label>
                                    <div class="col-sm-5">
                                        <input name="numberLimit" type="text" class="form-control"  placeholder="次数限制">
                                    </div>
                                </div>
                                <div class="form-group">
        ...
        <script type="text/javascript">
            ...
            function checkAccountNotExist(){
            	var account=$("#account").val();
            	var result=false;
            	$.ajax({
                	type:"post",
                	url:"${contextPath}/alabaoLimit/checkAccountExist?account="+account,
                	dateType:"json",
                	async:false,
