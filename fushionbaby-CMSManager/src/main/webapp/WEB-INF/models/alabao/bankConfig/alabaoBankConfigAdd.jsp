                ...
                <div class="col-md-12 content">
                    <div class="panel panel-info">
                        <div class="panel-heading">
                            <h3 class="panel-title"><i class="fa fa-cog"></i> 新增银行配置</h3>
                        </div>
                        <div class="panel-body">
                            <form class="form-horizontal" id="addRoleForm" action="${contextPath}/alabaoBankConfig/alabaoBankConfigAdd" method="post">
                                
                                	<div class="form-group">
                                    <label class="col-sm-2 control-label">银行编码：</label>
                                    <div class="col-sm-5">
                                        <input name="bankCode" type="text" class="form-control" placeholder="银行编码">
                                    </div>
                                </div>
                                	<div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-5">
                                        <input name="bankDesc" type="text" class="form-control"  placeholder="描述">
                                    </div>
                                </div>
                                <div class="form-group">
                                    	<label class="col-sm-2 control-label">银行的icon图：</label>
										<div class="col-sm-4">
											<input type="hidden" id="bankIconUrl" name="bankIconUrl"  value=""/>
											<input type="hidden" id="oldbankIconUrl" name="oldbankIconUrl" value="" >
