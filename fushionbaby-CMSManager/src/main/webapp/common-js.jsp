<%@ page language="java" contentType="text/html; charset=utf-8"
	...
	<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/fushionbaby/css/my.css">
	...
	<!-- BEGIN DATE -->
	<link href="${pageContext.request.contextPath}/media/css/datetimepicker.css" rel="stylesheet" type="text/css" charset="UTF-8"/>
	<script src="${pageContext.request.contextPath}/media/js/bootstrap-datetimepicker.js" type="text/javascript" charset="UTF-8"></script>
	<script src="${pageContext.request.contextPath}/media/js/bootstrap-datetimepicker.zh-CN.js" type="text/javascript" charset="UTF-8"></script>
	<!-- END DATE -->
	...
	<script>
		...
		jQuery(document).ready(function() {    
		   ...
		   /*广告就在下边其中一个,注释了这些目前没有发现广告,其他地方出现使用异常在看情况*/
