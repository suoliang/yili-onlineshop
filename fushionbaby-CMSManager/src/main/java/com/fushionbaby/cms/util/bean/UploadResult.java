...
public class UploadResult {
	...
	public UploadResult(String isSuccess, List<String> errorArray,
			String loaclRootPath, String fileNameBefore) {
		this.isSuccess = isSuccess;
		this.erroArray = errorArray;
		this.loaclRootPath = loaclRootPath;
		this.fileNameBefore = fileNameBefore;
	}
	...
	public List<String> getErroArray() {
		return erroArray;
	}

	public void setErroArray(List<String> erroArray) {
		this.erroArray = erroArray;
	}
