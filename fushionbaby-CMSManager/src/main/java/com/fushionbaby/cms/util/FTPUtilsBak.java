...
public class FTPUtilsBak {
	...
	public FTPUtilsBak(String server, int port, String uname, String password) {
		this.server = server;
		if (this.port > 0) {
			this.port = port;
		}
	...
	public FTPClient connectFTPServer() throws Exception {
		try {
			...
			ftp.makeDirectory("/var/ftp/pub/upload/hi2");
...
//		FTPUtilsBak fu=null;
//		try {
//			fu = new FTPUtilsBak("192.168.1.49", 22, "root", "root123db");
//			fu.connectFTPServer();
//            InputStream is=new ByteArrayInputStream("aaa".getBytes("utf-8"));
//			String fileName="测试.txt";
//			fu.uploadFile(is,new String(fileName.getBytes("UTF-8"),"iso-8859-1"));
//		} catch (Exception e) {
...
//	}
	...
	public static void main(String[] args) {
		FTPUtilsBak bak = new FTPUtilsBak("192.168.1.49", 21, "anonymous", "");
		try {
			bak.connectFTPServer();
			bak.uploadFile("E:\\image\\1.jpg", "1.jpg", "/var/ftp/pub/upload");
		} catch (Exception e) {
