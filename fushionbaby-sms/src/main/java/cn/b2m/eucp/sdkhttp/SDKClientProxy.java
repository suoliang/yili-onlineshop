...
public class SDKClientProxy implements cn.b2m.eucp.sdkhttp.SDKClient {
  private String _endpoint = null;
  private cn.b2m.eucp.sdkhttp.SDKClient sDKClient = null;
  ...
  private void _initSDKClientProxy() {
    try {
      sDKClient = (new cn.b2m.eucp.sdkhttp.SDKServiceLocator()).getSDKService();
      if (sDKClient != null) {
        if (_endpoint != null)
  ...
  public cn.b2m.eucp.sdkhttp.SDKClient getSDKClient() {
    if (sDKClient == null)
      _initSDKClientProxy();
    return sDKClient;
  }
