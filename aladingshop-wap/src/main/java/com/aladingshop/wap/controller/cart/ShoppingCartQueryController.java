...
public class ShoppingCartQueryController {
	...
	private static final Log LOGGER = LogFactory
			.getLog(ShoppingCartQueryController.class);
	...
	public String cartList(ModelMap model, HttpServletRequest request,
		...
		try {
			...
			queryCondition
					.setImageType(ImageStandardConstant.IMAGE_STANDARD_PC_183);

			String shoppingCartSid = RandomNumUtil
					.getCharacterAndNumber(WebConstant.UNIQUE_CODE);
			CookieUtil.setCookie(response,
					CookieConstant.COOKIESHOPPINGCARTSID, shoppingCartSid);
