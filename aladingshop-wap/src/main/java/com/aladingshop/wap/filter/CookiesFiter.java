package com.aladingshop.wap.filter;
...
public class CookiesFiter implements Filter {
	public void doFilter(ServletRequest request, ServletResponse response,
		...
		String visitKey = CookieUtil.getCookieValue(
				(HttpServletRequest) request, CartConstant.COOKIE_VISIT_KEY);
		...
		//
		// String curretnPath =
		// StringUtils.isBlank(httpRequest.getQueryString()) ?
		// httpRequest.getServletPath()
		// : httpRequest.getServletPath() + "?" + httpRequest.getQueryString();
		// String ingore =
		// "jpg,static,png,css,js,login,register,otherLogin,forget,images,gif";
		// if (!com.aladingshop.wap.util.StringUtils.isConsit(curretnPath,
		// ingore) && requestType == null) {
		// /** 登录不存储且ajax请求忽略 */
		// // 存储最后浏览URL到cookie
		// CookieUtil.setCookie((HttpServletResponse) response,
		// CookieConstant.COOKIE_CUURENT_URL, curretnPath,
