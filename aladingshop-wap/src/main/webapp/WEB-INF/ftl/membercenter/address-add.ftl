        ...
        <div class="container">
            ...
            <form id="addressAddForm" class="form-group" action="" method="post">
                ...
                <div class="input-group" id="area">
                    ...
                    <input name="area" id="finalArea" type="text" autocomplete="off">
                    <input name="provinceId" id="province" type="hidden" value="">
                    <input name="cityId" id="city" type="hidden" value="">
                    <input name="districtId" id="district"type="hidden" value="">
                    <i class="right"></i>
                    <s></s>
                </div>
                <div class="input-group">
                    <label for="name">详细地址：</label>
                    <input name="addressInfo" id="addressInfo" type="text" autocomplete="off">
                </div>
                <div class="input-group">
	...
	<script>
		...
		function submitForm(){
			...
			if(type !=null && type.toString().length>0){
				$('#addressAddForm').attr("action","${rc.contextPath}/address/addAddress?type=chooseAddress");
			} else {
				$('#addressAddForm').attr("action","${rc.contextPath}/address/addAddress");
			}
