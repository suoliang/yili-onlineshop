 ...
 <body class="backWhite">
		<div class="pT30 mB0">
              ...
              <div class="form-group mL0 mR0">
					...
					<div class="col-sm-4">
						<input id="grandcategoryCode" name="grandcategoryCode" class="form-control" type="text" value="${skuCategory.code}" readonly/>
					</div>
				 ...
				 <div class="form-group mL0 mR0">
					...
					<div class="col-sm-4">
						<input id="grandcategoryName"  class="form-control" type="text" value="${skuCategory.name}" readonly/>
					</div>
					<div class="error col-sm-4  textL">必填项</div>
				</div>
				...
				<div class="form-group mL0 mR0">
					...
					<div class="col-sm-4">
						<input id="categoryLevel" name="categoryLevel" class="form-control" type="text" value="${skuCategory.categoryLevel+1}" readonly/>
					</div>
				</div>
