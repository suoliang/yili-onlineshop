...
<!--                                 <button type="button" class="btn btn-success" onclick="downLoadExcel('批量导入标签商品模板\.xls')">下载标签商品模板</button> -->
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover" id="">
                                    ...
                                    <tbody>
                                    	<c:forEach items="${skuLabels}" var="skuLabel" varStatus="status">
                                    	<tr>
                                            ...
                                            <td>
                                                <a href="javascript:location='${contextPath}/store/skuLabel/skuListByLabel?labelCode=${skuLabel.code}'" class="btn btn-success btn-xs edit-role">关联商品</a>
...
<%-- 									 			<input type="hidden" id="modifyRemark" value="${MODIFY_REMARK}"> --%>
                            ...
                            <!-- 分页 -->
<%--                            <tags:page formId="findForm" url="${contextPath}/store/skuLabel/skuLabelList"></tags:page> --%>
                            <!-- 分页 end -->
                        </div>
                    </div>
                </div>
