  	...
  	<script type="text/javascript">
	 	function delSku(skuCode, labelCode){
	  		var submit =  function(v,h,f){
	  			if(v=="ok"){
	  				$.post("${contextPath }/store/skuLabel/deleteSkuLabelRelation",{skuCode: skuCode, labelCode: labelCode },function(result){
	  		  			if(result =="SUCCESS"){	
	  		  			jBox.tip("删除成功", 'info');
	  	...
	  	function showAddSkuLabel(labelCode){
	  		var url = "iframe:${contextPath}/store/skuLabel/addNoRelationSku?labelCode=" + labelCode;
			$.jBox(url, {
	              ...
	              if(v){
		              ...
		              var url= "${contextPath}/store/skuLabel/addSkuByLabel";
		              var skuCodes = "";
			  ...
			  <div class="col-md-12 content">
				<div class="panel panel-info">
                   <div class="panel-heading">
                      <h3 class="panel-title"><i class="fa fa-cog"></i> ${label.name }商品列表</h3>
                   </div>
                   <div class="panel-body">
				     <form class="form-inline page" id="findForm" method="post">
	                    ...
	                    <button type="button" class="btn btn-info" onclick="showAddSkuLabel('${label.code}')" >新增关联商品</button>
						<button class="btn btn-primary" type="button" onclick="javascript:location='${contextPath}/store/skuLabel/skuLabelList'">返回</button>
...
<%-- 									   <td>${sku.showOrder}</td>	 --%>
									   <td>
<%-- 									   	  <a class="btn btn-info btn-xs delete-role"  href="javascript:editSkuRel('${sku.skuCode}', '${skuLabel.code}');"   title="编辑">	 --%>
<!-- 										          编辑 -->
<!-- 										 </a> -->
										 <a class="btn btn-danger btn-xs delete-role"  href="javascript:delSku('${sku.skuCode}', '${label.code}')"   title="删除">	
										          删除
										 </a>
                           ...
                           <tags:page formId="findForm" url="${contextPath}/store/skuLabel/skuListByLabel"></tags:page>
                            <!-- 分页 end -->
