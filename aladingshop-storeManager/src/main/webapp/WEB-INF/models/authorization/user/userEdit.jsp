                            ...
                            <form class="form-horizontal" id="addRoleForm" action="${contextPath }/user/updateUser" method="post">
                               <input type="hidden" name="id" value="${authUser.id }">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-5">
                                        <input name="name" type="text" disabled="disabled" id="name" class="form-control" value="${authUser.name }" >
                                       <!--   <input name="name" type="hidden" disabled="disabled" id="name" class="form-control" value="${authUser.name }" >-->
                                    </div>
                                </div>
                                <div class="form-group">
                                   ...
                                   <div class="form-group">
                                    ...
                                    <div class="col-sm-5">
                                      <select name="userType" class="form-control lg-select" disabled>
