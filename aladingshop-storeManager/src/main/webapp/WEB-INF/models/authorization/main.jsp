        ...
        <nav class="navbar navbar-default">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#" title="首页"><i class="fa fa-medium text-info"></i> ALADing 门店管理系统</a>
                </div>
                <div class="collapse navbar-collapse" id="bs-navbar-collapse">
                    <ul class="nav navbar-nav navbar-right">
                        <li><a href="javascript:void(0);" class="cursorD"><i class="fa fa-user"></i>  <c:if test="${storeName!=null }">${storeName }</c:if></a></li>
                        <li><a href="javascript:void(0);" class="cursorD"><i class="fa fa-user"></i>  <c:if test="${userName!=null }">${userName }</c:if></a></li>
                        <li><a href="${pageContext.request.contextPath }/login/index" title="退出登录" id="signOut"><i class="fa fa-sign-out"></i> 退出登录</a></li>
                    </ul>
                </div>
            </div>
        </nav>
