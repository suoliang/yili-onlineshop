        ...
        <div class="container" id="loginBox">
            <div class="row">
                <div class="col-md-6 col-md-offset-3">
                    <h1 class="color-white mB30"><i class="fa fa-medium text-info"></i> ALADing 门店管理系统</h1>
                </div>
                <div class="col-md-6 col-md-offset-3">
                    <form id="loginForm" action="${contextPath }/login/main" method="post" >
                    	...
                    	<div class="form-group">
                                ...
                                <input type="text" class="form-control" name="storeNumber" placeholder="门店号" value="${storeNumber }">
                        ...
                        <div class="form-group">
                                ...
                                <input type="password" class="form-control input-block" name="password" placeholder="密码" value="${password }">
