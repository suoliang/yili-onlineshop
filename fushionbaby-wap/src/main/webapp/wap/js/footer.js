var a = "";
	...
	a+= "<li class='shouye'><a href='"+_ContextPath+"/index/indexList.do'>首页</a></li>";
	a+= "<li><a href='https://itunes.apple.com/us/app/dou-shi-bao/id953358017?mt=8'>客户端</a></li>";
	a+= "<li><a href='"+_ContextPath+"/cart/cartList.do'>购物车</a></li>";
	a+= "<li><a href='"+_ContextPath+"/membercenter/center.do'>我的</a></li>";
	a+= "</ul></div>";
