...
public class OrderDto implements Serializable {
	...
	private double total_actual;//最终金额
	private String order_status;//交易状态,订单状态
	private String order_information;//订单状态信息显示
	private String create_time;// 订单日期+时间,订单创建时间
	
	private String trans_code;//物流单号
	private String trans_name;//物流公司名称
	private String auditFailReason;//订单审核没通过原因(问题单)
