 ...
 * 
 */
package com.fushionbaby.facade.biz.common.yiduobao.dto;
 ...
 */
public class YiDuoBaoCardDto {
	public YiDuoBaoCardDto(List<MemberCard> inCards, List<MemberCard> reCards) {
